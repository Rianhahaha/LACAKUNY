...
class Kinerja1 extends BaseController
{
    ...
    public function aksesData(){
        ...
        return redirect()->to(base_url('/dev'))->withInput();
    }
    ...
    public function readExcel()
    {
        ...
        foreach ($sheet as $idx => $row) {
            ...
            {
                    $queryID=$this->KinerjaModel->getAll('pengguna',array('keterangan'=>$vl));
            ...
            $persentase=(intval($row['H']!=0))?(floatval($row['H'])/floatval($row['G'])*100).'%':0;
        ...
        return redirect()->to(base_url('/dev'));
    }
    ...
    public function deleteAll()
    {
        ...
        $this->KinerjaModel->deleteAll('foto',$params);
        $this->KinerjaModel->deleteAll('dokumen',$params);
        $paramsPengukuran=[
            'tahun_pengukuran'     => $this->tahun,
            'sistem_pengukuran'    => $this->sistem
        ];
