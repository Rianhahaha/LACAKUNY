...
<div class="page-body">
    <div class="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="btn-group">
                <button class="btn btn-ghost-dark btn-icon" data-bs-toggle="offcanvas" href="#sidebarsimproka"
            ...
            <!-- <button class="btn btn-outline-primary" data-bs-toggle="modal"
                    ...
                    <div class="btn-list">
                        <?php if(empty($data)): ?>
                        <form action="<?php echo base_url('simproka/readExcel'); ?>" method="post"
                        ...
                        <div>
                            <!-- KRO -->
                            <button class="btn d-none d-sm-inline-block" data-bs-toggle="modal"
                                data-bs-target="#modalkro">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="icon icon-tabler icon-tabler-plus text-primary" width="24" height="24"
                            ...
                            <button class="btn d-none d-sm-inline-block" data-bs-toggle="modal"
                                data-bs-target="#hapuskro1">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="icon icon-tabler icon-tabler-trash-x text-danger" width="24" height="24"
                                    viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                    <path d="M4 7h16"></path>
                        ...
                        <div>
                            <form action="<?php echo base_url('simproka/downloadFormat'); ?>" method="get">
                                <?= csrf_field(); ?>
                                ...
                                <button type="submit" class="btn d-none d-sm-inline-block">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="icon icon-tabler icon-tabler-file-download text-success" width="24"
                                ...
                                <button type="submit" class="btn d-sm-none btn-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="icon icon-tabler icon-tabler-file-upload text-success" width="24"
                                        height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                        fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                        <path d="M14 3v4a1 1 0 0 0 1 1h4"></path>
                        ...
                        <div>
                            <form action="" method="get">
                                ...
                                <button type="submit" class="btn d-none d-sm-inline-block">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="icon icon-tabler icon-tabler-file-import text-primary" width="24"
                                        height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                        fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                        <path d="M14 3v4a1 1 0 0 0 1 1h4"></path>
                        ...
                        <div>
                            ...
                            <button class="btn btn-danger d-sm-none btn-icon" data-bs-toggle="modal"
                                data-bs-target="#modal-danger">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trash-x"
                                    width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                    fill="none" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="card">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <!-- isi tabel 1 -->
                                <tbody>
                                    <?php $kodeSebelum=''; $before=''; $abjad=65; $idx=1; $mod=1;foreach ($data as $d) :?>
                                      
                                    <tr class='text-center' valign=middle  data-bs-trigger="hover" data-bs-toggle="popover"
                                                data-bs-content="Terakhir disunting : 01/01/2002" >
                                        <td>
                                            <?php if(!empty($d['status_validasi'])){?>
                                            <!-- input -->
                                            <button class="btn btn-ghost-primary" data-bs-toggle="modal"
                                                data-bs-target="#input<?=$mod;?>">
                                                Input
                                            </button>

                                            <?php $kodeSebelum=$before; } $before=$d['kode']; ?>
                                        </td>
                                        <td align=center>
                                            <!-- KRO -->

                                            <form action="simproka/detailPage" method="post">
                                                <div class="btn-group">
                                        ...
                                        <td>
                                            <!-- Data Dukung -->
                                            <span class="btn btn-ghost-primary" data-bs-toggle="modal"
                                        ...
                                        <td colspan=1>
                                            <!-- edit -->
                                            <form action="simproka/editPage" method="post">
                                        ...
                                        <td colspan=1>
                                            <span class="form-help" data-bs-trigger="hover" data-bs-toggle="popover"
                                                data-bs-content="Terakhir disunting : 01/01/2002">?</span>
                                        </td>
                                        <?php } ?>
                                    </tr>
...
<!-- modal tambah KRO -->
<div class="modal fade" id="modalkro" tabindex="-1" role="dialog" aria-hidden="true" data-bs-backdrop="static"
    data-bs-backdrop="false" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <form action="<?php echo base_url('simproka/insertSimproka'); ?>" method="POST">
            <?= csrf_field(); ?>
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="kode" id="kode" placeholder="Isikan kode!"
                                required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label required">Uraian</label>
                            <input type="text" class="form-control" name="uraian" id="uraian"
                                placeholder="Isikan uraian!" required>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="satuan" id="satuan"
                                    placeholder="Isikan satuan!" required>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="mb-3">
                                <label class="form-label required">Volume Target</label>
                                <input type="text" class="form-control" name="volume_target" id="volume_target"
                                    placeholder="Isikan volume target!" required>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- modal tambah KRO end -->
    ...
    <!-- modal tambah pilih -->
    <div class="modal fade" id="pilihedit" tabindex="-1" role="dialog" aria-hidden="true" data-bs-backdrop="static"
        data-bs-backdrop="false" data-bs-keyboard="false">
                ...
                <div class="modal-body modal-body text-center py-4">
                    ...
                    <div class="mb-3">
                        <button class="btn btn-outline-primary" style="width:200px;" data-bs-toggle="modal"
                            data-bs-target="#modalro"> Tambah RO</button>
                    </div>
                    <div class="mb-3">
                        <button class="btn btn-outline-primary" style="width:200px;" data-bs-toggle="modal"
                            data-bs-target="#modalkomponen"> Tambah Komponen</button>
                    </div>
                    <div class="mb-3">
                        <button class="btn btn-outline-primary" style="width:200px;"> Tambah Subkomponen</button>
                    </div>
    ...
    <!-- modal tambah RO -->
    <div class="modal fade" id="modalro" tabindex="-1" role="dialog" aria-hidden="true" data-bs-backdrop="static"
        data-bs-backdrop="false" data-bs-keyboard="false">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <form action="<?php echo base_url('simproka/insertSimproka'); ?>" method="POST">
                <?= csrf_field(); ?>
                <div class="modal-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    <label class="form-label required">Volume Target</label>
                                    <input type="text" class="form-control" name="volume_target" id="volume_target"
                                        placeholder="Isikan volume target!">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                            data-bs-target="#pilihedit">Kembali</button>
    ...
    <div class="modal fade" id="modalkomponen" tabindex="-1" role="dialog" aria-hidden="true" data-bs-backdrop="static"
        data-bs-backdrop="false" data-bs-keyboard="false">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <div class="col-4">
                            <div class="mb-3">
                                ...
                                <select name="sistem" class="form-control" placeholder="Pilih Tahun">
                                    <option value="1">DK.4471.DBA.001
                                    </option>
                                    <option value="2">DK.4471.DBA.003
                                    </option>
                                    <option value="3">DK.4471.DBA.004
                                    </option>
                                </select>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="modalsubkomponen" tabindex="-1" role="dialog" aria-hidden="true"
        data-bs-backdrop="static" data-bs-backdrop="false" data-bs-keyboard="false">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah RO</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-3">
                            <div class="mb-3">
                                <label class="form-label required">Kode</label>
                                <input type="text" class="form-control" name="example-text-input" value="DK.4471.CBJ"
                                    disabled>
                            </div>
                        </div>
                        <div class="col-9">
    ...
    <div class="modal fade" id="modal-hapuspw" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <form action="<?php echo base_url('simproka/deleteAll'); ?> " method="post">
                <div class="modal-content">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    <div class="modal-status bg-danger"></div>
                    <div class="modal-body text-center py-4">
                        ...
                        <div class="input-group input-group-flat">
                            ...
                            <span class="input-group-text">
                                <a href="#" class="link-secondary" title="" data-bs-toggle="tooltip" onclick="showPW()"
                        ...
                        <div class="input-group">
                            <label class="form-check">
                                <input class="form-check-input" type="checkbox" id="hapusDokumen" name="hapusDokumen"
                                    value="true">
    ...
    <?php $mod=1; foreach ($data as $d) :  ?>
    <!-- Modal data dukung -->
    <div class="modal fade" id="doc<?=$mod;?>" aria-labelledby="EditPK" data-bs-backdrop="static"
        data-bs-backdrop="false" data-bs-keyboard="false">
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
            <div class="modal-content">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td align=middle style="width: 10px;">
                                <form action="<?php echo base_url('simproka/downloadFile');?>" method="post"
                                    enctype="multipart/form-data">
                            ...
                            <td style="width: 10px;">
                                <a href="<?= $fl['lokasi']; ?>" class="btn btn-outline-secondary btn-icon"
                                    target="_blank">
                            ...
                            <td style="width: 10px;">
                                <form action="<?php echo base_url('simproka/deleteDokumen');?>" method="post"
                                    enctype="multipart/form-data">
                ...
                <form name="formsubmit" action="<?php echo base_url('simproka/storeMultipleFile'); ?>" method="POST"
                    enctype="multipart/form-data">
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-danger" data-bs-target="#progres<?=$mod;?>"
                            data-bs-toggle="modal">Kembali</button>
                        <div>
                            <div class="input-group">
                                <input type="hidden" name="kode" id="kode>" value="<?= $d['kode']; ?>">
                                <input name="dok[]" id="dok[]" type="file" onchange="validateSize(this)"
                                    accept="image/*,.pdf" class="form-control mr-auto" multiple ref="fileref"
                                    @change="onChange">
                                <p id="size"></p>
...
<!-- modal input -->
<div class="modal fade" id="input<?=$mod;?>" aria-labelledby="EditKRO" tabindex="-1" role="dialog" aria-hidden="true"
    data-bs-backdrop="static" data-bs-backdrop="false" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-scorllable modal-lg modal-dialog-centered" role="document">
        <form action="<?php echo base_url('simproka/editSimproka'); ?>" method="POST">
            <?= csrf_field(); ?>
            <input type="hidden" name="kode" id="kode" value="<?= $d['kode']; ?>">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-4">
                            <div class="mb-3">
                                <input type="hidden" class="form-control" name="kodeSebelum" id="kodeSebelum"
                                    value="<?=$akhir; ?>">
                                <label class="form-label required">Volume Target</label>
                                <input class="form-control" id="volume_target" name="volume_target"
                                    placeholder="Isikan Volume Target!" value="<?= $d['volume_target']; ?>" required>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="mb-3">
                                <label class="form-label required">Capaian Volume</label>
                                <input type="text" class="form-control" id="capaian_volume" name="capaian_volume"
                                    placeholder="Isikan Capaian Volume!" value="<?= $d['capaian_volume']; ?>" required>
                            </div>
                        </div>

                        <div class="mb-3">
                            <label class="form-label required">Progress</label>
                            <textarea class="form-control" id="progres" name="progres" data-bs-toggle="autosize"
                                placeholder="Isikan Progress!" required><?= $d['progres']; ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label required">Capaian Rill</label>
                            <textarea class="form-control" id="capaian_rill" name="capaian_rill"
                                data-bs-toggle="autosize" placeholder="Isikan Capaian Rill!"
                                required><?= $d['capaian_rill']; ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label required">Satuan Rill</label>
                            <textarea class="form-control" id="satuan_rill" name="satuan_rill" data-bs-toggle="autosize"
                                placeholder="Isikan Satuan Rill!" required><?= $d['satuan_rill']; ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label required">Status</label>
                            <textarea class="form-control" id="status" name="status" data-bs-toggle="autosize"
                                placeholder="Isikan Status!" required><?= $d['status']; ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label required">Penjelasan</label>
                            <textarea class="form-control" id="penjelasan" name="penjelasan" data-bs-toggle="autosize"
                                placeholder="Isikan Penjelasan!" required><?= $d['penjelasan']; ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label required">Kendala</label>
                            <textarea class="form-control" id="kendala" name="kendala" data-bs-toggle="autosize"
                                placeholder="Isikan Kendala!" required><?= $d['kendala']; ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label required">Tindak Lanjut</label>
                            <textarea class="form-control" id="tindak_lanjut" name="tindak_lanjut"
                                data-bs-toggle="autosize" placeholder="Isikan Tindak Lanjut!"
                                required><?= $d['tindak_lanjut']; ?></textarea>
                        </div>
...
<!-- modal edit -->
<div class="modal fade" id="editkro<?=$mod;?>" aria-labelledby="EditKRO" tabindex="-1" role="dialog" aria-hidden="true"
    data-bs-backdrop="static" data-bs-backdrop="false" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-scorllable modal-lg modal-dialog-centered" role="document">
        <form action="<?php echo base_url('simproka/editSimproka'); ?>" method="POST">
            <?= csrf_field(); ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-10">
                            <div class="mb-3">
                                <label class="form-label required">Kode</label>
                                <input class="form-control" id="newKode" name="newKode" value="<?= $d['kode'];?>"
                                    disabled>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="mb-3">
                                <label class="form-label"><br></label>
                                <button class="btn btn-outline-primary" data-bs-toggle="modal"
                                    data-bs-target="#pilihpic<?= $mod; ?>">Pilih PIC</button>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label class="form-label required">Uraian</label>
                            <textarea class="form-control" id="uraian" name="uraian"
                                data-bs-toggle="autosize"><?= $d['uraian']; ?></textarea>
                        </div>
                        <div class="col-4">
                            <div class="mb-3">
                                <label class="form-label required">Satuan</label>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <tr>
                                ...
                                <td> <input class="form-control" id="newKode" name="newKode" value="<?= $d['kode'];?>"
                                        disabled></td>
                            </tr>
                            <tr>
                                <td valign="middle" width="20px"> <b>Uraian</b></td>
                                <td> <textarea class="form-control" id="uraian" name="uraian"
                                        data-bs-toggle="autosize"><?= $d['uraian']; ?></textarea></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td> <input class="form-control" id="volume_target" name="volume_target"
                                        placeholder="Isikan Volume Target!" value="<?= $d['volume_target']; ?>"
                                        required></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td> <input type="text" class="form-control" id="capaian_volume" name="capaian_volume"
                                        placeholder="Isikan Capaian Volume!" value="<?= $d['capaian_volume']; ?>"
                                        required> </td>

                            </tr>
                            <tr>
                                <td valign="middle"><b>Progres</b></td>
                                <td> <textarea class="form-control" id="progres" name="progres"
                                        data-bs-toggle="autosize" placeholder="Isikan Progress!"
                                        required><?= $d['progres']; ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td valign="middle"><b>Capaian Rill</b></td>
                                <td> <textarea class="form-control" id="capaian_rill" name="capaian_rill"
                                        data-bs-toggle="autosize" placeholder="Isikan Capaian Rill!"
                                        required><?= $d['capaian_rill']; ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td> <textarea class="form-control" id="capaian_rill" name="capaian_rill"
                                        data-bs-toggle="autosize" placeholder="Isikan Satuan Rill!"
                                        required> </textarea>
                                </td>
                            </tr>
                            <tr>
                                <td valign="middle"><b>Status</b></td>
                                <td> <textarea class="form-control" id="status" name="status" data-bs-toggle="autosize"
                                        placeholder="Isikan Status!" required><?= $d['status']; ?></textarea></td>
                            </tr>
                            <tr>
                                <td valign="middle"><b>Penjelasan</b></td>
                                <td> <textarea class="form-control" id="penjelasan" name="penjelasan"
                                        data-bs-toggle="autosize" placeholder="Isikan Penjelasan!"
                                        required><?= $d['penjelasan']; ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td valign="middle"><b>Kendala</b></td>
                                <td> <textarea class="form-control" id="kendala" name="kendala"
                                        data-bs-toggle="autosize" placeholder="Isikan Kendala!"
                                        required><?= $d['kendala']; ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td valign="middle"><b>Tindak Lanjut</b></td>
                                <td> <textarea class="form-control" id="tindak_lanjut" name="tindak_lanjut"
                                        data-bs-toggle="autosize" placeholder="Isikan Tindak Lanjut!"
                                        required><?= $d['tindak_lanjut']; ?></textarea>
                                </td>
                            </tr>
...
<!-- modal pilih PIC -->
<div class="modal fade" id="pilihpic<?= $mod; ?>" aria-labelledby="EditPK" data-bs-backdrop="static"
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-md">
        ...
        <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                data-bs-target="#editkro<?=$mod;?>">Kembali</button>
            <button type="submit" class="btn btn-success">Simpan
                Perubahan</button>
        </div>
    </div>
...
<!-- modal hapus KRO11 -->
<div class="modal fade" id="hapuskro1" tabindex="-1" role="dialog" aria-hidden="true" data-bs-backdrop="static"
    data-bs-backdrop="false" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="mb-3">
                            ...
                            <select type="text" class="form-select tomselected ts-hidden-accessible" placeholder="Select a date" id="select-tags" value="" tabindex="-1">
