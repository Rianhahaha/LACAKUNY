        ...
        <div class="container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-end">
                    <div class="col">
                        <!-- Page pre-title -->
                        <form action="kinerja/aksesData" method="post">
                            <div class="page-pretitle">Pilih Triwulan</div>
                            <div class="btn-group">
                                <select id="sistem" name="sistem" class="form-control" placeholder="Pilih Tahun">
                                ...
                                <button type="submit" class="btn btn-outline-secondary"> Pilih </button>
                            </div>
                        </form>
                    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                            ...
                            <tbody>
                                ...
                                ?>
                                        ...
                                        <tr valign=middle>
                                            ...
                                            <td align=middle>
                                                <!-- progress -->
                                                <span class="btn btn-outline-primary" id="btn-progres<? $mod; ?>" data-bs-toggle="modal" style="width:90px;" data-bs-target="#progres<?= $mod; ?>">
                                                    Progress
                                                </span>
                                                <span class="btn btn-outline-primary" id="btn-kendala<? $mod; ?>" data-bs-toggle="modal" style="width:90px;" data-bs-target="#kendala<?= $mod; ?>">
                                                    Kendala
                                                </span>
                                                <span class="btn btn-outline-primary" data-bs-toggle="modal" style="width:90px;" data-bs-target="#strategi<?= $mod; ?>">
                                                    Strategi
                                                </span>
                                            </td>
                                            ...
                                            <td rowspan=1>
                                                <a class="btn btn-ghost-primary" data-bs-toggle="modal" data-bs-target="#pic<?= $mod; ?>">
                                            ...
                                            <td align=middle>
                                                <?php if (($admin == true)) {
                                                    if (trim($d['status']) == 'validasi') { ?>
                                                        ...
                                                        <form action="<?php echo base_url('kinerja/setStatus'); ?>" method="POST">
                                                            ...
                                                            <input type="hidden" name="status<?= $idx; ?>" id="status<?= $idx; ?>" value="selesai">
                                                        ...
                                                        <form action="<?php echo base_url('kinerja/setStatus'); ?>" method="POST">
                                                            ...
                                                            <input type="hidden" name="id<?= $idx; ?>" id="id<?= $idx; ?>" value="<?= $d['id_pengguna']; ?>">
                                                            <input type="hidden" name="iku<?= $idx; ?>" id="iku<?= $idx; ?>" value="<?= $d['iku']; ?>">
                                                            <input type="hidden" name="status<?= $idx; ?>" id="status<?= $idx; ?>" value="revisi">
                                                            <input type="hidden" name="index" id="index" value="<?= $idx; ?>">
                                                ...
                                                if ($koor == true) { ?>
                                                    ...
                                                    <?php if ((trim($d['status']) != 'selesai') && (trim($d['status']) != 'validasi')) { ?>
                                                        <button type="submit" id="AS<?= $idx; ?>" class="btn btn-outline-yellow" style="width:90px;" data-bs-toggle="modal" data-bs-target="#modal-valid<?= $idx; ?>" <?php
                                                                                                                                                                                                                        if (($d['presentase'] == 0) || ($totalFile[trim($d['iku'])] == 0) || ($d['komentar'] == ''
                                                                                                                                                                                                                        )) : ?> disabled <?php endif; ?>>
                                                            Ajukan
                                                        </button>
                                                <?php }
                                                ...
                                                <!-- Modal batalkan -->
                                                <div class="modal fade" id="modal-batal<?= $idx; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer justify-content-between">
                                                                ...
                                                                <form action="<?php echo base_url('kinerja/setStatus'); ?>" method="POST">
                                                                    ...
                                                                    <input type="hidden" name="id<?= $idx; ?>" id="id<?= $idx; ?>" value="<?= $d['id_pengguna']; ?>">
                                                                    <input type="hidden" name="iku<?= $idx; ?>" id="iku<?= $idx; ?>" value="<?= $d['iku']; ?>">
                                                                    <input type="hidden" name="status<?= $idx; ?>" id="status<?= $idx; ?>" value="validasi">
                                                                    <input type="hidden" name="index" id="index" value="<?= $idx; ?>">
                                                ...
                                                <!-- Modal valid -->
                                                <div class="modal fade" id="modal-valid<?= $idx; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            <div class="modal-status bg-danger"></div>
                                                            ...
                                                            <div class="modal-footer justify-content-between">
                                                                ...
                                                                <form action="<?php echo base_url('kinerja/setStatus'); ?>" method="POST">
                                                                    ...
                                                                    <button type="submit" id="AS<?= $idx; ?>" class="btn btn-danger" style="width:90px;">
                                                ...
                                                <!-- modal kendala -->
                                                <div class="modal fade" id="kendala<?= $mod; ?>" aria-labelledby="EditPK" data-bs-backdrop="static" data-bs-keyboard="false">
                                                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-md">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body" style="text-align:left">
                                                                <table>
                                                                    <form action="<?php echo base_url('kinerja/saveDetail'); ?>" method="post" enctype="multipart/form-data">
                                                                        <?= csrf_field(); ?>
                                                                        ...
                                                                        <textarea name="kendala<?= $idx; ?>" id="kendala<?= $idx; ?>" class="form-control" data-bs-toggle="autosize" placeholder="isikan kendala..." <?php
                                                                                                                                                                                                                        if ((trim($d['status']) == 'selesai') || (trim($d['status']) == 'validasi')) { ?> disabled <?php } ?>><?= $d['kendala']; ?></textarea>
                                                                </table>
                                                            </div>
                                                ...
                                                <!-- modal strategi -->
                                                <div class="modal fade" id="strategi<?= $mod; ?>" aria-labelledby="EditPK" data-bs-backdrop="static" data-bs-keyboard="false">
                                                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-md">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"> Analisis Progress Capaian Triwulan</h5>
                                                            ...
                                                            <div class="modal-body" style="text-align:left">
                                                                <table>
                                                                    ...
                                                                    <form action="<?php echo base_url('kinerja/saveDetail'); ?>" method="post" enctype="multipart/form-data">
                                                                        ...
                                                                        <textarea name="strategi<?= $idx; ?>" id="stretegi<?= $idx; ?>" class="form-control" data-bs-toggle="autosize" placeholder="isikan strategi..." <?php
                                                                                                                                                                                                                        if ((trim($d['status']) == 'selesai') || (trim($d['status']) == 'validasi')) { ?> disabled <?php } ?>><?= $d['strategi']; ?></textarea>
                                                                </table>
                                                            </div>
                                                            <div class="modal-footer justify-content-between">
                                                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Keluar</button>
                                                ...
                                                <!-- Modal pic new -->
                                                <div class="modal fade" id="pic<?= $mod; ?>" tabindex="-1" role="dialog" aria-hidden="true" data-bs-backdrop="static" data-bs-backdrop="false" data-bs-keyboard="false">
                                                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body" style="text-align:left">
                                                                ...
                                                                <form action="<?php echo base_url('kinerja/editIKK'); ?>" method="post" enctype="multipart/form-data">
                                                                    <?= csrf_field(); ?>
                                                                    <div class="row">
                                                                        <input type="hidden" name="id<?= $idx; ?>" id="id<?= $idx; ?>" value="<?= $d['id_pengguna']; ?>">
                                                                        <input type="hidden" name="iku<?= $idx; ?>" id="iku<?= $idx; ?>" value="<?= $d['iku']; ?>">
                                                                        ...
                                                                        <?php if ($admin == true) { ?>
                                                                            <div class="col-9">
                                                                                <div class="mb-3">
                                                                                    ...
                                                                                    <textarea name="ikk<?= $idx; ?>" id="ikk<?= $idx; ?>" class="form-control" data-bs-toggle="autosize" required <?php if ((trim($d['status']) == 'selesai') || (trim($d['status']) == 'validasi')) { ?> disabled <?php } ?>> <?= $d['indikator']; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-3">
                                                                                <div class="mb-3">
                                                                                    ...
                                                                                    <input name="target_pk<?= $idx; ?>" id="target_pk<?= $idx; ?>" class="form-control" placeholder="<?= $d['target_pk']; ?>" value="<?= $d['target_pk']; ?>" required <?php if ((trim($d['status']) == 'selesai') || (trim($d['status']) == 'validasi')) { ?> disabled <?php } ?>>
                                                                                </div>
                                                                            </div>
                                                                        <?php } ?>
                                                                        <div class="col-9">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input name="target_tw<?= $idx; ?>" id="target_tw<?= $idx; ?>" class="form-control" placeholder=" <?= $d['target_tw']; ?>" value="<?= $d['target_tw']; ?>" required <?php if ((trim($d['status']) == 'selesai') || (trim($d['status']) == 'validasi')) { ?> disabled <?php } ?>>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <div class="mb-3">
                                                                                <label class="form-label required">Capaian TW</label>
                                                                                <input name="capaian_tw<?= $idx; ?>" id="capaian_tw<?= $idx; ?>" class="form-control" placeholder="<?= $d['capaian']; ?>" value="<?= $d['capaian']; ?>" required <?php if ((trim($d['status']) == 'selesai') || (trim($d['status']) == 'validasi')) { ?> disabled <?php } ?>>
                                                                            </div>
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            <label class="form-label required"">Komentar</label>
                                                                        <textarea name=" komentar<?= $idx; ?>" id="komentar<?= $idx; ?>" class="form-control" data-bs-toggle="autosize" required <?php if ((trim($d['status']) == 'selesai') || (trim($d['status']) == 'validasi')) { ?> disabled <?php } ?>><?= $d['komentar']; ?></textarea>
                                                                        </div>
                                                                    </div>
                                                            </div>
                                                ...
                                                <!-- Modal pic old -->
                                                <div class="modal fade" aria-labelledby="EditPK" data-bs-backdrop="static" data-bs-keyboard="false">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <?php if ($admin == true) { ?>
                                                                                    <td>
                                                                                        <!-- IKK -->
                                                                                        <textarea name="ikk<?= $idx; ?>" id="ikk<?= $idx; ?>" class="form-control" data-bs-toggle="autosize" <?php if ((trim($d['status']) == 'selesai') || (trim($d['status']) == 'validasi')) { ?> disabled <?php } ?>> <?= $d['indikator']; ?></textarea>
                                                                                    </td>
                                                                                    <td class="position:relative">
                                                                                        <!-- Target PK -->
                                                                                        <input name="target_pk<?= $idx; ?>" id="target_pk<?= $idx; ?>" class="form-control" placeholder="<?= $d['target_pk']; ?>" <?php if ((trim($d['status']) == 'selesai') || (trim($d['status']) == 'validasi')) { ?> disabled <?php } ?>>

                                                                                    </td>
                                                                                <?php } ?>
                                                                                <td>
                                                                                    <!-- Target TW -->
                                                                                    <input name="target_tw<?= $idx; ?>" id="target_tw<?= $idx; ?>" class="form-control" placeholder=" <?= $d['target_tw']; ?>" <?php if ((trim($d['status']) == 'selesai') || (trim($d['status']) == 'validasi')) { ?> disabled <?php } ?>>

                                                                                </td>
                                                                                <td>
                                                                                    <!-- Capaian TW -->
                                                                                    <input name="capaian_tw<?= $idx; ?>" id="capaian_tw<?= $idx; ?>" class="form-control" placeholder="<?= $d['capaian']; ?>" <?php if ((trim($d['status']) == 'selesai') || (trim($d['status']) == 'validasi')) { ?> disabled <?php } ?>>

                                                                                </td>
                                                                                <td>
                                                                                    <!-- Komentar -->
                                                                                    <textarea name="komentar<?= $idx; ?>" id="komentar<?= $idx; ?>" class="form-control" data-bs-toggle="autosize" <?php if ((trim($d['status']) == 'selesai') || (trim($d['status']) == 'validasi')) { ?> disabled <?php } ?>> <?= $d['komentar']; ?></textarea>
                                                                                </td>
                                                ...
                                                <div class="modal fade" id="doc<?= $mod; ?>" aria-labelledby="EditPK" data-bs-backdrop="static" data-bs-backdrop="false" data-bs-keyboard="false">
                                                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
                                                        <div class="modal-content">
                                                                        ...
                                                                        if (($dc['iku'] == $d['iku'])) : ?>
                                                                            <tr>
                                                                                ...
                                                                                <td align=middle style="width: 10px;">
                                                                                    <form action="<?php echo base_url('kinerja/downloadFile'); ?>" method="post" enctype="multipart/form-data">
                                                                                ...
                                                                                <td style="width: 10px;">
                                                                                    <a href="<?= $dc['lokasi']; ?>" class="btn btn-outline-secondary btn-icon" target="_blank">
                                                                                ...
                                                                                <td style="width: 10px;">
                                                                                    <form action="<?php echo base_url('kinerja/deleteDokumen'); ?>" method="post" enctype="multipart/form-data">
                                                                                        ...
                                                                                        <input type="hidden" name="index" id="index" value="<?= $x; ?>">
                                                                                        <input type="hidden" name="lokasi<?= $x; ?>" id="lokasi<?= $x; ?>" value="<?= $dc['lokasi']; ?>">
                                                                                        <input type="hidden" name="dok<?= $x; ?>" id="dok<?= $x; ?>" value="<?= $dc['dokumen']; ?>">
                                                            ...
                                                            <form name="formsubmit" action="<?php echo base_url('kinerja/storeMultipleFile'); ?>" method="POST" enctype="multipart/form-data">
                                                                <div class="modal-footer justify-content-between">
                    ...
                    <!--modal progres new-->
                    <div class="modal fade" id="progres<?= $mod; ?>" tabindex="-1" role="dialog" aria-hidden="true" data-bs-backdrop="static" data-bs-backdrop="false" data-bs-keyboard="false">
                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Analisis Progress Capaian Triwulan</h5>
                                ...
                                <div class="modal-body" style="text-align:left">
                                    ...
                                    <form action="<?php echo base_url('kinerja/saveDetail'); ?>" method="POST">
                                        <?= csrf_field(); ?>
                                        <div class="row">
                                            <input type="hidden" name="id<?= $idx; ?>" id="id<?= $idx; ?>" value="<?= $d['id_pengguna']; ?>">
                                            <input type="hidden" name="iku<?= $idx; ?>" id="iku<?= $idx; ?>" value="<?= $d['iku']; ?>">
                                            ...
                                            <div class="col-10">
                                                <div class="mb-1">
                                                    ...
                                                    <textarea name="progres<?= $idx; ?>" id="progres<?= $idx; ?>" class="form-control" data-bs-toggle="autosize" placeholder="Isikan Progres!" required <?php if ((trim($d['status']) == 'selesai') || (trim($d['status']) == 'validasi')) { ?> disabled <?php } ?>><?= $d['progres']; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="col-2">
                                                <div class="mb-1">
                                            ...
                                            <?php if ($admin == true) { ?>
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="deskripsi<?= $idx; ?>" id="deskripsi<?= $idx; ?>" class="form-control" data-bs-toggle="autosize" placeholder="Isikan keterangan untuk PIC!"><?php if (!empty(trim($d['deskripsi']))) { ?><?= $d['deskripsi'];
                                                                                                                                                                                                                                                            } ?></textarea>
                                                </div>

                                            <?php }
                                            if (($admin == false) && (!empty(trim($d['deskripsi'])))) { ?>
                                                <div class="mb-3">
                                                    <label class="form-label required">Keterangan</label>
                                                    <textarea name="deskripsi<?= $idx; ?>" id="deskripsi<?= $idx; ?>" class="form-control" data-bs-toggle="autosize" placeholder="Isikan keterangan untuk PIC!"><?php if (!empty(trim($d['deskripsi']))) { ?><?= $d['deskripsi'];
                                                                                                                                                                                                                                                            } ?></textarea>
                                ...
                                <div class="modal-footer justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-success" <?php
                                                                                    if ((($admin != true) && ($totalFile[trim($d['iku'])] == 0))) { ?> disabled <?php } ?>>Simpan Perubahan
                                    </button>
                                </div>
                                </form>
                            </div>
                    ...
                    <div class="modal fade" aria-labelledby="EditPK" data-bs-backdrop="static" data-bs-keyboard="false">
                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
                            ...
                            <div class="modal-footer justify-content-between">
                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Keluar</button>
                                <button type="submit" class="btn btn-success" <?php
                                                                                if ((($admin != true) && ($totalFile[trim($d['iku'])] == 0))) { ?> disabled <?php } ?>>Simpan
                                    Perubahan
                                </button>
                            </div>
                            </form>
