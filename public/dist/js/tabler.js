            ...
            Array.prototype.forEach.call(e.length ? e : [e], function (e) {
              return (function (e) {
                ...
                function c() {
                  ...
                  if (
                    (r < t
                      ? "hidden" === n.overflowY && (u("scroll"), s(), (r = "content-box" === n.boxSizing ? Math.round(parseFloat(window.getComputedStyle(e, null).height)) : e.offsetHeight))
                      : "hidden" !== n.overflowY && (u("hidden"), s(), (r = "content-box" === n.boxSizing ? Math.round(parseFloat(window.getComputedStyle(e, null).height)) : e.offsetHeight)),
                    l !== r)
                  ) {
                    l = r;
      ...
      },
      {
        ...
        value: function nearestInputPos() {
          ...
          return this.currentMask
            ? (_this$currentMask5 = this.currentMask).nearestInputPos.apply(_this$currentMask5, args)
